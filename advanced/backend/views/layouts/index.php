        ...
        <ul class="nav pull-right">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><a href="?r=admin/myinfo">个人信息管理</a></li>
                    <li><a href="?r=admin/userinfo">修改密码</a></li>
                    <li><a href="#">订单管理</a></li>
                </ul>
            </li>
            ...
            <li class="settings hidden-phone">
<!--                                    <a href="--><?php //echo Url::to('login/logout')?><!--" role="button">-->
                <a href="?r=login/logout" role="button">
...
<!--            <a href="--><?php //echo Url::to('index/index')?><!--">-->
        ...
        <li>
            ...
            <ul class="submenu">
                <li><a href="?r=admin/list">管理员列表</a></li>
                <li><a href="?r=admin/adduser">新增管理员</a></li>
                <li><a href="?r=admin/userinfo">管理员信息</a></li>
            </ul>
        </li>
        <li>
            <a class="dropdown-toggle" href="#">
            ...
            <ul class="submenu">
                <li><a href="?r=user/list">用户列表</a></li>
                <li><a href="?r=user/adduser">新增用户</a></li>
                <li><a href="?r=user/userinfo">用户信息</a></li>
            </ul>
        </li>
        <li>
            <a class="dropdown-toggle" href="#">
            ...
            <ul class="submenu">
                <li><a href="?r=tables/showcase">基本表单</a></li>
                <li><a href="?r=tables/wizard">步骤表单</a></li>
            </ul>
        </li>
        <li>
            <a href="?r=gallery/index">
                <i class="icon-picture"></i>
                <span>相册管理</span>
            </a>
        </li>
        <li>
            <a href="?r=calendar/index">
                <i class="icon-calendar-empty"></i>
                <span>日历事件管理</span>
            </a>
        </li>
        <li>
            <a href="?r=tables/index">
                <i class="icon-th-large"></i>
                <span>表格</span>
            </a>
        </li>
        <li>
            <a href="?r=user/myinfo">
                <i class="icon-cog"></i>
                <span>我的信息</span>
            </a>
        </li>

                ...
                <ul>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            ...
                            <li><a href="index.php?r=login/index">Login/Register</a></li><li><a href="http://www.moke8.com">More</a></li>
                        </ul>
                    </li>
                </ul>
            </div><!-- /.col -->
            ...
            <div class="col-xs-12 col-sm-6 no-margin">
                <ul class="right">
                    ...
                    <?php  if(Yii::$app->session['isLogin'] == 1):?>
                        欢迎您回来，请您去畅游商品吧！！！<?php echo Yii::$app->session['loginname']?><a href="?r=member/logout">退出</a>
                    <?php else:?>
                        <li><a href="?r=login/reg">Register</a></li>
                        <li><a href="?r=login/index">Login</a></li>
                    <?php endif;?>
                </ul>
            </div><!-- /.col -->
        </div><!-- /.container -->
